...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	CGFloat x = globalKit.libraryInfo.x;
	...
	for (int i=0;i<numCols;i++) {
        ...
        CGRect frame=[uiGridViewDelegate gridView:self frameForRowAt:cell.rowIndex AndColumnAt:cell.colIndex];
		cell.frame = CGRectMake(x+frame.origin.x, frame.origin.y, frame.size.width, frame.size.height);
		x += thisWidth;
	}
